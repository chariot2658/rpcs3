...
inline constexpr std::array<byte, 41> configuration_descriptor = {
	...
	0x09, 0x21, 0x11, 0x01, 0x00, 0x01, 0x22, 0x82, 0x00,
	0x07, 0x05, 0x82, 0x03, 0x10, 0x00, 0x02,
	0x07, 0x05, 0x01, 0x03, 0x20, 0x00, 0x04};
inline constexpr std::array<byte, 130> report_descriptor = {
...
using input_report = std::array<byte, 15>;
struct input
{
...
// Replies observed in plug_t500_in.pcapng, not guessed firmware versions.
